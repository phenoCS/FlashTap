...
REM Unblock all files (Mark-of-the-Web from GitHub ZIP)
...
REM Detect admin rights (multiple methods for Win10/Win11 compatibility)
set ADMIN=0
net session >nul 2>&1 && set ADMIN=1
if %ADMIN%==0 (
    whoami /groups 2>nul | findstr /i "S-1-16-12288" >nul 2>&1 && set ADMIN=1
)
